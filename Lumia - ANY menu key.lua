    ...
    Mfunc = {
        ...
        ComboBox = function(text, items, currentIndex, selectedIndex, callback, menoffset, yoff, xoff)
            ...
            if clickedleft2 and LumiaF.func.HoverOn(x + tw1 - 17 + 2,y + 5,10,12) then
                LumiaF.func.DrawSomeText("←", 0, false, x + tw1 - 17 + 2, y - 0.50, LumiaF.config.ButtonScale, 0, 0, 0, 255)
            else
                LumiaF.func.DrawSomeText("←", 0, false, x + tw1 - 17 + 2, y - 0.50, LumiaF.config.ButtonScale, LumiaF.config.CText.r, LumiaF.config.CText.g, LumiaF.config.CText.b, LumiaF.config.CText.a)
            end
